...
pub(super) fn view(page: PageId) -> SiteView {
    SiteView {
        ...
        page: match page {
            ...
            PageId::AdminModels => super::en_workspace::admin_models(),
            PageId::AdminAnnouncements => super::en_workspace::admin_announcements(),
            PageId::AdminSettings => super::en_workspace::admin_settings(),
            PageId::AdminSite => super::en_workspace::admin_site(),
            PageId::AdminSeo => super::en_workspace::admin_seo(),
