        ...
        vec![
            ...
            tutorial!(
                ...
                vec![
                    ...
                    "Have your own model service, API key, and model name. The key normally stays in client secure storage; only manual sync can upload a client-encrypted opaque account record.",
                ],
                vec![
                    step(
                        "Step 1",
