...
pub(super) fn view(page: PageId) -> SiteView {
    SiteView {
        ...
        page: match page {
            ...
            PageId::AdminModels => super::zh_cn_workspace::admin_models(),
            PageId::AdminAnnouncements => super::zh_cn_workspace::admin_announcements(),
            PageId::AdminSettings => super::zh_cn_workspace::admin_settings(),
...
fn shell(current: PageId) -> SiteShell {
    ...
    SiteShell {
        ...
        brand_note: "原生 SSH 运维工作台".into(),
        home_href: PageId::Home.path().to_owned(),
        skip_label: "跳到主要内容".into(),
        menu_label: "菜单".into(),
        navigation: vec![
        ...
        alternate_lang: Locale::En.code().into(),
        utility_navigation_label: "快捷入口".into(),
        github_repository: RepositoryLink::github("在新标签页打开 Creation-SSH GitHub 仓库"),
        footer_summary: "客户端与常驻 agent 协作的跨平台 SSH 运维产品。".into(),
        footer_motto: "岁月牵涉年华，流年纠结浮生".into(),
        footer_note: "Creation Cloud 只做控制面，不代理 SSH 数据面。".into(),
