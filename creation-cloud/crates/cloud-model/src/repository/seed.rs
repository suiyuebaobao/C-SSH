...
pub(crate) const SYSTEM_MODEL_SEEDS: [SystemModelSeed; 16] = [
    ...
    seed(
        ...
        Some("ernie-5.1"),
        Some("https://qianfan.baidubce.com/anthropic"),
        Some("ernie-5.1"),
    ),
    seed(
        14,
        ...
        Some("hy3"),
        Some("https://tokenhub.tencentmaas.com"),
        Some("hy3"),
    ),
    seed(
        15,
        ...
        "iFlytek",
        192_000,
        Some("https://spark-api-open.xf-yun.com/x2"),
        Some("spark-x"),
        None,
        None,
    ),
    seed(
        ...
        "Baichuan",
        32_000,
        Some("https://api.baichuan-ai.com/v1"),
        Some("Baichuan4-Turbo"),
        None,
        None,
    ),
    seed(
...
const fn seed(
    ...
    openai_model_name: Option<&'static str>,
    anthropic_base_url: Option<&'static str>,
    anthropic_model_name: Option<&'static str>,
) -> SystemModelSeed {
    SystemModelSeed {
        id: seed_id(suffix),
        name,
