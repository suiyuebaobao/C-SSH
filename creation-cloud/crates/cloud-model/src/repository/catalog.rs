...
const MODEL_COLUMNS: &str = "id, name, provider, api_format, base_url, model_name, context_length, \
...
pub(crate) async fn create(
    ...
    let sql = format!(
        "INSERT INTO global_model_catalog \
         (id, name, provider, api_format, base_url, model_name, context_length, capability_tags, \
...
pub(crate) async fn replace(
    ...
    let sql = format!(
        "UPDATE global_model_catalog SET name=$2, provider=$3, api_format=$4, base_url=$5, \
         model_name=$6, context_length=$7, capability_tags=$8, default_parameters=$9, \
         enabled=$10, is_default=$11, sort_order=$12, revision=revision+1, \
